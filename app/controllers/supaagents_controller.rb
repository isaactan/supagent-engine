class SupaagentsController < ApplicationController
  ...
  private
    ...
    def supaagent_params
      params.require(:supaagent).permit(:is_flagged, :applicationid, :name, :email, :idimage, :bankcountry, :validation, :idnumber, :bankaccount, :bankaddress, :bankname, :bankswift, :referralid, :terms, :bankbranch, :status, :id)
    end
